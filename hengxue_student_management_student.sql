...
(
    ...
    major_id               varchar(32)           null comment '专业ID',
    exam_level_id          varchar(32)           null comment '报考层次ID',
    enroll_point_id        varchar(32)           null comment '报名点ID',
    otherorder             tinyint(1) default 0  null comment '外单',
    status_id              char(32)              null comment '状态ID'
)
    comment '学生表';
